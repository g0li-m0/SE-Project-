...
public class MostInstalls extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // fetch apps by MostInstalls
        appViewModel.fetchMostInstalls();
        appViewModel.getMostInstalls().observe(this, apps1 -> {
            Toast.makeText(MostInstalls.this, "working", Toast.LENGTH_SHORT).show();

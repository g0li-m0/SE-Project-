...
public class MostRating extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // fetch apps by MostRating()
        appViewModel.fetchMostRating();
        appViewModel.getMostRating().observe(this, apps1 -> {
            Toast.makeText(MostRating.this, "working", Toast.LENGTH_SHORT).show();
